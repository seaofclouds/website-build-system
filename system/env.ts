...
export const Env = {
  // ─── YOUR SITE ────────────────────────────────────────────────────────────
  // This is the entire configuration surface of the build system.
  //
  // There's no config file, and there shouldn't be. This build system is meant
  // to be *part of* your website rather than a dependency you configure from the
  // outside — so the config is just a handful of variables you edit in place.
  ...
  // The preview image used when someone shares a link to a page that doesn't
  // specify its own `image` frontmatter. Leave blank to omit the tag entirely.
  ogImage: "",

  // The name of the include (in template/includes/) that holds your docs
